...
> **Important change**: The Linux kernel RNG as [changed substantially](https://www.zx2c4.com/projects/linux-rng-5.17-5.18/) in kernel versions 5.17-5.18. From these versions on, the kernel will usually report an available entropy of ```256```, which, due to the improved algorithm used by the kernel to generate random numbers from entropy, is considered sufficient and you can skip to the next chapter.
...
An entropy pool value greater than 2000 (256 for kernel 5.17+) is sufficient.
